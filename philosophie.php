  ...
  <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 matiere-details cgu">
            <h3>Un taux d’échec élevé en Wallonie et à Bruxelles.</h3>
            <p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center citation">
            « La plus parfaite éducation consiste à habituer le disciple à se passer de maître.»<br />
            <small>- R. Sabatier</small>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 matiere-details cgu">
            <h3>… en agissant sur la confiance en soi et la motivation.</h3>
            <p>
