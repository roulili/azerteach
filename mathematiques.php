...
<html lang="fr">
  <head>
    ...
    <title>Azerteach - Cours particulier en mathématiques</title>
    ...
    <!--Open Graphs-->
    <meta property="og:title" content="Azerteach - Mathématiques" >
    <meta property="og:type" content="website" >
    <meta property="og:description" content="Cours particulier et études encadrées sur Bruxelles">
    <meta property="og:url" content="http://www.azerteach.com/mathematiques">
...
<?php include('./includes/navbar.php'); ?>
    ...
    <div class="section section-matiere-top">
      <div class="container">
        ...
        <h1 class="page-title">Mathématiques<br/><small>simplicité et poésie</small></h1>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 matiere-details">
            ...
            <p>
              L'association Azerteach propose <strong>différentes activités</strong> de soutien et d'aide en maths, tant pour les élèves du primaire et du secondaire que pour les étudiants du supérieur.
            </p>
            <ul>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 matiere-details">
            ...
            <p>
              Tous les <strong>mercredis et samedis après-midi</strong>, nous organisons des <span class="text-blue">séances d'étude encadrée en maths</span> pour assurer, sur toute l'année, <strong>un accompagnement régulier</strong> des élèves qui se sentent perdus face à leur cours de maths. Répartis en <strong>petits groupes</strong> les étudiants sont encadrés par un <strong>professeur de maths</strong> expérimenté et compétent.
            </p>
            <p>Ces séances sont idéales pour:</p>
            <ul class="blue-dot-grey-text">
              <li><span class="text-grey"><strong>Expliquer</strong> l'ensemble de la matière</span></li>
              <li><span class="text-grey">Réaliser les <strong>devoirs de maths</strong></span></li>
              <li><span class="text-grey">Se préparer pour une <strong>interrogation</strong> ou les <strong>examens</strong></span></li>
            </ul>
            <p>
              De plus, les <span class="text-blue">études encadrées en maths</span> aident l'étudiant à développer une <strong>méthode de travail</strong> qui lui soit propre et le rende capable de résoudre, de façon autonome, un problème de maths, quel qu'il soit.
            </p>
            <hr>
    ...
    <img class="visible-xs-block imgcrop" src="./img/imgcrop3.png" alt="imagecrop">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 matiere-details">
            ...
            <hr>
            <p class="more-info text-blue"><a href="/stages">+ d'info</a></p>
          </div>
        </div>
      </div>
    </div>
