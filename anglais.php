...
<html lang="fr">
  <head>
    ...
    <title>Azerteach - Cours partiuclier en anglais</title>
    ...
    <!--Open Graphs-->
    <meta property="og:title" content="Azerteach - Sciences" >
    <meta property="og:type" content="website" >
    <meta property="og:description" content="Cours particulier et études encadrées sur Bruxelles">
    <meta property="og:url" content="http://www.azerteach.com/anglais">
...
<?php include('./includes/navbar.php'); ?>
    ...
    <div class="section section-matiere-top">
      <div class="container">
        ...
        <h1 class="page-title">Anglais<br/><small>to be or not to be</small></h1>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 matiere-details">
            ...
            <ul class="blue-dot-grey-text">
              ...
              <li><span class="text-grey">Réaliser les <strong>devoirs d'anglais</strong></span></li>
