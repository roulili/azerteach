...
<html lang="fr">
  <head>
    ...
    <title>Azerteach - Cours particulier en néerlandais</title>
    ...
    <!--Open Graphs-->
    <meta property="og:title" content="Azerteach - Néerlandais" >
    <meta property="og:type" content="website" >
    <meta property="og:description" content="Cours particulier et études encadrées sur Bruxelles">
    <meta property="og:url" content="http://www.azerteach.com/neerlandais">
...
<?php include('./includes/navbar.php'); ?>
    ...
    <div class="section section-matiere-top">
      <div class="container">
        ...
        <h1 class="page-title">Néerlandais<br/><small>la langue de Vondel</small></h1>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-8 col-md-offset-2 matiere-details">
            ...
            <ul class="blue-dot-grey-text">
              ...
              <li><span class="text-grey">Réaliser les <strong>devoirs de néerlandais</strong></span></li>
    ...
    <img class="visible-xs-block imgcrop" src="./img/imgcrop4.png" alt="imagecrop">
