...
<html lang="fr">
  <head>
    ...
    <title>Azerteach - Méthode de travail sur Bruxelles</title>
    ...
    <!--Open Graphs-->
    <meta property="og:title" content="Azerteach - Méthode de travail">
    <meta property="og:type" content="website" >
    <meta property="og:description" content="Cours particulier et études encadrées sur Bruxelles">
    <meta property="og:url" content="http://www.azerteach.com/methode-de-travail">
...
<?php include('./includes/navbar.php'); ?>
    ...
    <div class="section section-service-top">
      ...
      <div class="container">
        ...
        <h1 class="page-title">Méthode de travail<br/><small>ordre et méthode</small></h1>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-2 text-center citation">
            « Grâce aux objectifs fixés ici, même quand je n'avais plus envie ans ma tête j'arrivais à avancer. »<br />
            <small>- Mélissa</small>
          </div>
        </div>
      </div>
